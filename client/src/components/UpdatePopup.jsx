    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
            <div className="bg-gray-800 rounded-2xl border border-gray-700 shadow-2xl max-w-md w-full overflow-hidden transform transition-all scale-100 animate-scaleUp">
                ...
                <div className="bg-gradient-to-r from-green-900/40 to-gray-800 p-6 border-b border-gray-700 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-green-500/10 rounded-full blur-3xl -mr-10 -mt-10"></div>
                    <div className="relative z-10 flex items-center gap-3">
                        <span className="material-symbols-outlined text-green-500 text-3xl bg-green-500/10 p-2 rounded-lg">campaign</span>
                ...
                <div className="p-6 pt-2 bg-gray-800/50">
                    <button
                        onClick={onClose}
                        className="w-full py-3 px-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-green-900/40 transform hover:-translate-y-0.5 cursor-pointer flex items-center justify-center gap-2 group"
                    >
